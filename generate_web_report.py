    ...
    <main class="max-w-6xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
        ...
        <section class="mt-8 bg-white p-5 shadow-sm">
            ...
            <div class="mt-4 overflow-x-auto">
                <table class="min-w-full text-left text-sm">
                    <thead class="border-b bg-gray-50 text-xs uppercase text-gray-500">
                        <tr><th class="py-2 px-3">Jugador</th><th class="py-2 px-3">Equipo</th><th class="py-2 px-3">Precio</th><th class="py-2 px-3 text-center">Media</th><th class="py-2 px-3 text-center">Puntos</th>{lineup_headers}<th class="py-2 px-3">Expira</th></tr>
                    </thead>
